			  	...
			  	<div id="tab-leavefeedback">
					...
					<div id="feedback-form">
						<form action="commentSubmit.php" method="post">			
							...
							<input name="GUID" style="display: none" value="<?php echo $GUID ?>"/>
							<input name="SUID" style="display: none" value="<?php echo $SUID ?>"/>
							<input name="UUID" style="display: none" value="<?php echo $UUID ?>"/>
